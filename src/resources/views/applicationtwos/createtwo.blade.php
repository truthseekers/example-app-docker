...
<body>
    <div class="container mt-2">
        <div class="row">
            <div class="col-lg-12 margin-tb">
                <div class="pull-left mb-2">
                    <h2>CashFactory Loan Application</h2>
                </div>
                <div class="pull-right">
                    <a class="btn btn-primary" href="{{ route('applicationtwos.index') }}">View Applications</a>
                </div>
            </div>
        </div>
        @if(session('status'))
        ...
        @endif
        <form action="{{ route('applicationtwos.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
